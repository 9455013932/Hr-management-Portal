            ...
            <div className='w-full h-full bg-white shadow-2xl flex flex-col gap-5 Project relative'>
                                ...
                                allResult && allResult.map((items, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className='flex gap-2 items-center justify-center my-1'>
                                            ...
                                            {/* <button className='p-2 shadow-md rounded-full text-lg hover:bg-red-700 hover:border hover:shadow-md hover:shadow-red-600 text-white bg-red-600' disabled onClick={() => handleDelete(items)}><MdDelete /></button> */}
                                        </td>
                                    </tr>
                                ))
                            }
                ...
                {popUp && (
                    <form target='_blank' onSubmit={changeValue ? handleUpdate : handleSubmit} style={{ zIndex: '100' }} className='absolute w-full top-14'>
                        ...
                        <div className='bg-white py-6   SADF rounded flex flex-col  relative sm:mx-10 mx-3 overflow-y-scroll h-[75vh] shadow-current shadow-sm font-serif sm:px-4  gap-2 md:gap-6'>
