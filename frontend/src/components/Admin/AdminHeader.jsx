    ...
    return (
        <div className='flex items-center bg-gray-50 shadow-md'>
            <div className='h-14 w-full flex items-center justify-between pl-[8vw] pr-5'>
                ...
                <p className='sm:text-xl md:text-2xl lg:text-3xl text-md font-semibold font-serif hidden sm:block'>
                    PURODHA INFRABUILD LLP
                </p>
            ...
            {
                openMenu && (
                    <div className='min-w-32 bg-slate-50 font-serif px-3 py-3 rounded-sm shadow-md shadow-blue-400 flex flex-col gap-3 whitespace-nowrap justify-start absolute right-2 top-14' style={{ zIndex: '10' }}>
